...
const solutions = [
    {
        ...
        description: 'Best moderation & security tools for your discord server.',
        href: '#',
        icon: ShieldCheckIcon,
    },
    {
        name: 'Economy simulation ',
        description: 'Want to make a roleplay server? Obelisk is your solution.',
        href: '#',
        icon: CashIcon,
    },
    {
        name: 'Integrations',
        description: "Auto-posts from twitter, twitch, youtube, etc.",
        href: '#',
        icon: ViewGridIcon,
    },
    {
        name: 'Automations',
        description: 'Want to automate your server? Obelisk is your solution.',
        href: '#',
        icon: RefreshIcon,
    },
]
const callsToAction = [
    { name: 'Add to server', href: '#', icon: PlayIcon },
